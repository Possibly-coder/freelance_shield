      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
            ...
            <div className="mt-4 pt-4 border-t border-gray-800">
              ...
              <div className="flex flex-wrap gap-2">
                {project.skills.map((skill) => (
                  <span key={skill} className="text-sm bg-gray-800 text-gray-300 px-3 py-1 rounded-full">
                    {skill}
                  </span>
                ))}
              </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className="text-right">
                      ...
                      {proposal.estimated_duration && (
                        <p className="text-xs text-gray-500">{proposal.estimated_duration}</p>
                      )}
                    </div>
                  </div>

                  <p className="text-sm text-gray-300 mb-4">{proposal.cover_letter}</p>
          ...
          <div className="card">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">The client will review your proposal and get back to you.</p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmitProposal} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-gray-400 mb-1">Your Rate ({project.currency})</label>
        ...
        {!user && project.status === "open" && (
          <div className="card text-center py-8">
            <p className="text-gray-400 mb-4">Sign up or log in to submit a proposal</p>
