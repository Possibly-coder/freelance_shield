  ...
  return (
    <PageShell>
      <div className="text-center mb-16">
        <p className="text-sm font-semibold text-blue-400/80 tracking-widest uppercase mb-3">How it works</p>
      ...
      <div className="space-y-8 mb-20">
        {[
          ...
          <div key={s.step} className="card flex items-start gap-6">
            ...
            <div>
              <div className="text-xs text-gray-600 font-mono mb-1">Step {s.step}</div>
