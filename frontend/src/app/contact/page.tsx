  ...
  return (
    <PageShell>
      <div className="text-center mb-16">
        <p className="text-sm font-semibold text-blue-400/80 tracking-widest uppercase mb-3">Contact</p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          <div className="card">
            ...
            <p className="text-blue-400 text-sm mt-2">hello@freelanceshield.com</p>
          </div>
          <div className="card">
            <MessageCircle className="w-6 h-6 text-emerald-400 mb-3" />
            <h3 className="font-semibold mb-1">Twitter / X</h3>
            <p className="text-gray-400 text-sm">Follow us for updates and DM for quick questions</p>
            <p className="text-blue-400 text-sm mt-2">@FreelanceShield</p>
          </div>
          <div className="card">
            <div className="text-sm text-gray-500 leading-relaxed">
              <p className="font-semibold text-gray-300 mb-2">Response times</p>
